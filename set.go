...
import (
	"github.com/phuicy/go-set/b16set"
	"github.com/phuicy/go-set/b32set"
	"github.com/phuicy/go-set/b64set"
	"github.com/phuicy/go-set/b8set"
	"github.com/phuicy/go-set/f32set"
	"github.com/phuicy/go-set/f64set"
	"github.com/phuicy/go-set/i16set"
	"github.com/phuicy/go-set/i32set"
	"github.com/phuicy/go-set/i64set"
	"github.com/phuicy/go-set/i8set"
	"github.com/phuicy/go-set/iset"
	"github.com/phuicy/go-set/strset"
	"github.com/phuicy/go-set/u16set"
	"github.com/phuicy/go-set/u32set"
	"github.com/phuicy/go-set/u64set"
	"github.com/phuicy/go-set/u8set"
	"github.com/phuicy/go-set/uset"
)
